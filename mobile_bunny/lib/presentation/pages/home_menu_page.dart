...
class _MenuPageState extends ConsumerState<MenuPage> {
        ...
        child: BottomNavigationBar(
          ...
          items: const [
            BottomNavigationBarItem(
                icon: Icon(Icons.edit_location), label: 'Restaurant'),
            BottomNavigationBarItem(
  ...
  Widget buildCategorySection(
      String title, List<Map<String, dynamic>> data, BuildContext context) {
    // Filtrer les données en fonction de la catégorie
    final categoryItems =
        data.where((item) => item['category'] == title).toList().take(3);
            ...
            itemBuilder: (context, index) {
              if (itemsWithSeeMore[index]['name'] == 'Voir plus $title') {
                return Card(
                  ...
                  color:
                      const Color(0xFF1C1C1C), // Fond de la carte en gris foncé
                  child: SizedBox(
                    width: 150,
